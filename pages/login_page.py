...
class LoginPage(BasePage):
    """
    Page Object for the Login page of the web site
    """
    ...
    def should_be_login_form(self):
        assert self.is_element_present(*LoginPageLocators.LOGIN_FORM), "Login form element is absent"

    def should_be_register_form(self):
        assert self.is_element_present(*LoginPageLocators.REGISTER_FORM), "Register form element is absent"
